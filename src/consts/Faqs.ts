export const FAQS = [
    ...
    },
    {
        ...
        answer: "Asi es, todo el contenido de la app se encuentra actualizado a la última versión disponible del libro del nuevo conductor, nos encontramos constantemente aumentando nuestra base de preguntas para que te prepares de la mejor manera posible y al mejor precio del mercado.",
    },
    {
        id: 5,
    ...
    },
    {
        ...
        answer: "Para eliminar la cuenta hay dos caminos: Directo desde tu app debes solicitar la eliminación, esta acción elimina todos los datos personales de nuestra base de datos. Solicitar la eliminación de la cuenta al correo electrónico hola@dreamco.cl y en un plazo de 24 horas todos tus datos serán eliminados.",
    },
] as const